...
class RunCardLO(RunCard):
    ...
    def default_setup(self):
        ...
        self.add_param("ebeam1", 50000.0, fortran_name="ebeam(1)")
        self.add_param("ebeam2", 50000.0, fortran_name="ebeam(2)")
        self.add_param("polbeam1", 0.0, fortran_name="pb1")
        self.add_param("polbeam2", 0.0, fortran_name="pb2")
        self.add_param("pdlabel", "cteq6l1")
        ...
        #pt cut
        self.add_param("ptj", 40.0, cut=True)
        self.add_param("ptb", 40.0, cut=True)
        ...
        self.add_param("etab", 5.0, cut=True)
        ...
        # DRJJ
        self.add_param("drjj", 0.0, cut=True)
        ...
        self.add_param("draj", 0.3, cut=True)
        ...
        # invariant mass
        self.add_param("mmjj", 40.0, cut=True)
        self.add_param("mmbb", 40.0, cut=True)
        ...
        self.add_param("stmin", 0.0, cut=True)
        self.add_param("stmax", -1.0, cut=True)
